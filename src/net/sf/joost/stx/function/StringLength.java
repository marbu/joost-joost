/*
 * $Id: StringLength.java,v 1.1 2006/03/20 19:23:50 obecker Exp $
 * 
...
final public class StringLength implements Instance
{
   ...
   public String getName() { return FunctionTable.FNSP + "string-length"; }

   public Value evaluate(Context context, int top, Tree args)
      throws SAXException, EvalException
   {
      return new Value(FunctionTable.getOptionalValue(context, top, args)
